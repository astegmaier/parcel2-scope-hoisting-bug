...
const getResolveAlias = require("fluentui-local-scripts/webpack/getResolveAlias");
const { createServeConfig } = require("fluentui-local-scripts/webpack/webpack-resources");
